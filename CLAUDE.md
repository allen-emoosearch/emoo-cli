...
emoo data search -k <keyword> [--page-size 20] [--current-page 1] [--text-format plain|markdown] [-f '<filter>']
emoo data get [--page-size 50] [--cursor <cursor>] [--text-format plain|markdown] [-f '<filter>']
